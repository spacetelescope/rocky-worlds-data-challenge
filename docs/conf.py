...
project = 'Rocky Worlds Data Challenge'
package_name = 'rocky_worlds_data_challenge'
author = 'STScI'
...
release = package_version(package_name)
...
# Render NumPy-style Attributes sections as field lists so they document
# attributes without registering duplicate objects alongside automodapi's
# generated ``autoattribute`` entries.
...
# Hide class-level placeholder values such as ``None`` from attribute docs.
